...
public class Crawler {
    ...
    private static LinkedList<UrlDepthPair> getAllLinks(URL url, int depth) {
        try {
            ...
            PrintWriter writer = new PrintWriter(outStream, true); // позволяет упростить интернационализацию программы
            ...
            BufferedReader reader = new BufferedReader(new InputStreamReader(input)); //читает текст из потока ввода символов
