...
public class module_5{
    ...
    public static void main(String [] args) throws NoSuchAlgorithmException{
        Task01("Hello", "72 33 -73 84 -12 -3 13 -13 -68");
        Task02("Rook", "A8", "H8");
        Task03("butl", "beautiful");
        Task04("1 2 3 4 5 6");
        Task05("hoops chuff bot bottom");
        Task06("4276380164144474");
        Task07(126);
        Task08("Fluffy@home");
        Task09("jOn SnoW, kINg IN thE noRth.");
        Task10(19);
    }

    public static void Task01(String str, String sArr){
        System.out.println();
    ...
    public static void Task02(String name, String start, String end){
        System.out.println();
    ...
    public static void Task03(String str1, String str2){
        System.out.println();
    ...
    public static void Task04(String sMass){
        System.out.println();
    ...
    public static int sumDigProd(String sMass) {
        ...
        for (int i = 0; i < mass.length; i++){
            mass[i] = Integer.parseInt(massS[i]); // выбирает цифры из символов
        }
        int sum = 0;
        for (int value : mass) {
            sum += value;
    ...
    public static ArrayList<String> sameVowelGroup(String str) {
        ...
        for (int i = 1; i < strs.length; i++) {
            ...
            if (pass) result.add(strs[i]); // если тру, то добавляем слово
        }
        return result;
    }

    public static void Task06(String cardNum){
        System.out.println();
    ...
    public static boolean validateCard(String cardNum) {
        ...
        if (cardNum.length() >= 14 && cardNum.length() <= 19) {
            ...
            for (int i = 0; i < cardNumStr.length(); i++) {
                if (i % 2 != 0) {
                    int c = Character.getNumericValue(cardNumStr.charAt(i)) * 2; // преобразует числовой символ в число двойной точности с плавающей запятой

                    if (c > 9) {
                        String buf = Integer.toString(c);

                        str.append(Character.getNumericValue(buf.charAt(0)) + Character.getNumericValue(buf.charAt(1))); // добавляет строковое предсталвение int к этой последовательности
                    } else {
                        str.append(c);
                    }
                } else {
    ...
    public static void Task08(String str) throws  NoSuchAlgorithmException{
        System.out.println();
